...
- The predicate function 'isOdd()' should accept an individual number as a parameter and evaluate whether or not that number is odd. This function will also need to return something (hint: think boolean values...).
