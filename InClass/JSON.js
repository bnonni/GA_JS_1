...
// Then go to http://jsonlint.com/ and paste it into the validator. Does it pass the test of being valid JSON? --Yes
...
var grungeAlbumsJS = JSON.parse(grungeAlbumsJSON);
